static class Constante
{
    ...
    public const string GRAPH_ELEC = "consommationIndirecte/ValeurParJour/electricite";
    public const string GRAPH_EAU = "consommationIndirecte/ValeurParJour/eau";
    public const string GRAPH_GAZ = "consommationIndirecte/ValeurParJour/gaz";
}
